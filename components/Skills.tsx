...
export default function Skills() {
  return (
    <section id="skills" className="bg-slate-50 py-20 px-4 md:px-8">
      <div className="mx-auto max-w-6xl">
        <div className="text-center mb-12">
          <p className="text-sm uppercase tracking-[0.35em] text-purple-600">Skills</p>
          <h2 className="mt-4 text-3xl font-bold text-slate-900 sm:text-4xl">My Skills</h2>
        </div>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {skills.map((skill) => (
            <div key={skill.name} className="rounded-3xl bg-white p-6 shadow-sm ring-1 ring-slate-200">
              <div className="flex items-center gap-4 mb-5">
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-500">{skill.level}% proficiency</p>
                </div>
              </div>
